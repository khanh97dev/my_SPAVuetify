  ...
  },
  {
    ...
    children: [
      { path: 'van-don-dang-theo-doi', name: 'excel.VanDonDangTheoDoi', component: require('$comp/excel/VanDonDangTheoDoi.vue').default },
      {
        ...
        redirect: { name: 'excel.BaoCaoBanHangs.XuLy' },
  ...
  ...applyRules(['auth'], [{
    ...
    children: [
      ...
      },
      {
        ...
        meta: { breadcrumb: 'Mailbox' }
      },
      {
        path: '/snackbar',
        name: 'Snackbar',
        component: page('Snackbar.vue'),
        meta: { breadcrumb: 'Snackbar' }
      },
      {
        path: '/calendar',
        name: 'Calendar',
